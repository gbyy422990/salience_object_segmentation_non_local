...
class Model:
    ...
    def build_model(self):
        ...
        self.Fea_Global_1 = tf.nn.relu(self.Conv_2d(self.pool6, [5, 5, 1024, fea_dim], 0.01,
        ...
        self.Fea_P6 = tf.nn.relu(self.Conv_2d(self.pool6, [3, 3, 1024, fea_dim], 0.01, padding='SAME', name='Fea_P6'))
